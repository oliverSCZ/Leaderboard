...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"sendNewData\": () => (/* binding */ sendNewData),\n/* harmony export */   \"receiveData\": () => (/* binding */ receiveData)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n/* harmony import */ var _render_message_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./render-message.js */ \"./src/render-message.js\");\n// eslint-disable-next-line import/no-cycle\n\n\n\nconst sendNewData = (username, score) => {\n  fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/FRQ4BNagXuOdP7UyIiqT/scores/', {\n    method: 'POST',\n    body: JSON.stringify({\n      user: username,\n      score,\n    }),\n    headers: { 'Content-type': 'application/json; charset=UTF-8' },\n  })\n    .then((data) => {\n      if (data.ok) {\n        (0,_render_message_js__WEBPACK_IMPORTED_MODULE_1__.renderSucces)('Succesfully added a new record');\n      } else {\n        throw new Error('Please provide valid username and score');\n      }\n    })\n    .catch((err) => {\n      (0,_render_message_js__WEBPACK_IMPORTED_MODULE_1__.renderError)(`Something went wrong: ${err.message}. Try again`);\n    });\n};\n\nconst receiveData = async () => {\n  const response = await fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/FRQ4BNagXuOdP7UyIiqT/scores/');\n  const data = await response.json();\n  const sortedScores = data.result.sort((a, b) => a.score - b.score);\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.populateContainer)(sortedScores);\n};\n\n//# sourceURL=webpack://leaderboard/./src/dataAPI.js?");
...
eval("module.exports = __webpack_require__.p + \"9d1e5585aa00830a7916.png\";\n\n//# sourceURL=webpack://leaderboard/./src/background.png?");
